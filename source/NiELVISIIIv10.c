/**
 * NI ELVIS III Control Module NI FPGA Interface C API Wrapper source file.
 *
 * Copyright (c) 2017,
...
/**
 * Global NI ELVIS III Control Module NiFpga Session.
 ...
 * NI ELVIS III Control Module personality bitfile is programmed to the FPGA, started, and is
 * running. The NI ELVIS III Control Module personality bitfile (.lvbitx file) for your target
